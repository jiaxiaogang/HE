...
+(AIFeatureNode*) recognitionFeatureV2_Step3:(AIFeatureJvBuModels*)resultModel colorDic:(NSDictionary*)colorDic at:(NSString*)at ds:(NSString*)ds logDesc:(NSString*)logDesc {
    ...
    for (AIFeatureJvBuModel *model in resultModel.models) {
        ...
        //
        //============ 0-3 ============
        //36 [08:15:56:530 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //39 [08:15:56:613 TI           TIUtils.m 535] 单特征识别结果:T199{Mnist0 = 1.00;}     匹配条数:29/ass38    匹配度:0.59    符合度:1.0    健全度:29.0    匹配率:0.8
        //48 [08:15:56:708 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //51 [08:15:56:727 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 1.00;}     匹配条数:10/ass36    匹配度:0.67    符合度:1.0    健全度:10.0    匹配率:0.3
        //60 [08:15:56:797 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //63 [08:15:56:839 TI           TIUtils.m 535] 单特征识别结果:T282{Mnist0 = 3.34;}     匹配条数:8/ass10    匹配度:0.41    符合度:1.0    健全度:8.0    匹配率:0.8
        //65 [08:15:56:845 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 1.00;}     匹配条数:11/ass36    匹配度:0.48    符合度:1.0    健全度:11.0    匹配率:0.3
        //87 [08:15:57:958 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //90 [08:15:57:995 TI           TIUtils.m 535] 单特征识别结果:T279{Mnist0 = 3.17;}     匹配条数:10/ass29    匹配度:0.36    符合度:1.0    健全度:10.0    匹配率:0.3
        //92 [08:15:58:000 TI           TIUtils.m 535] 单特征识别结果:T199{Mnist0 = 1.00;}     匹配条数:10/ass38    匹配度:0.36    符合度:1.0    健全度:10.0    匹配率:0.3
        //94 [08:15:58:009 TI           TIUtils.m 535] 单特征识别结果:T232{Mnist0 = 1.00;}     匹配条数:7/ass45    匹配度:0.32    符合度:1.0    健全度:7.0    匹配率:0.2
        //
        //============ 0-4 ============
        //128 [08:16:01:602 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //131 [08:16:01:636 TI           TIUtils.m 535] 单特征识别结果:T282{Mnist0 = 3.34;}     匹配条数:10/ass10    匹配度:0.45    符合度:1.0    健全度:10.0    匹配率:1.0
        //133 [08:16:01:644 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 1.66;}     匹配条数:10/ass36    匹配度:0.45    符合度:1.0    健全度:10.0    匹配率:0.3
        //149 [08:16:01:757 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //152 [08:16:01:787 TI           TIUtils.m 535] 单特征识别结果:T282{Mnist0 = 7.23;}     匹配条数:8/ass10    匹配度:0.39    符合度:1.0    健全度:8.0    匹配率:0.8
        //154 [08:16:01:793 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 1.66;}     匹配条数:8/ass36    匹配度:0.39    符合度:1.0    健全度:8.0    匹配率:0.2
        //183 [08:16:03:026 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //186 [08:16:03:062 TI           TIUtils.m 535] 单特征识别结果:T305{Mnist0 = 2.01;}     匹配条数:7/ass10    匹配度:0.49    符合度:1.0    健全度:7.0    匹配率:0.7
        //188 [08:16:03:065 TI           TIUtils.m 535] 单特征识别结果:T317{Mnist0 = 2.10;}     匹配条数:5/ass10    匹配度:0.44    符合度:1.0    健全度:5.0    匹配率:0.5
        //190 [08:16:03:071 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 2.29;}     匹配条数:5/ass36    匹配度:0.40    符合度:1.0    健全度:5.0    匹配率:0.1
        //192 [08:16:03:077 TI           TIUtils.m 535] 单特征识别结果:T232{Mnist0 = 1.00;}     匹配条数:7/ass45    匹配度:0.27    符合度:1.0    健全度:7.0    匹配率:0.2
        //
        //============ 0-5 ============
        //246 [08:16:06:838 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //249 [08:16:06:859 TI           TIUtils.m 535] 单特征识别结果:T282{Mnist0 = 7.23;}     匹配条数:6/ass10    匹配度:0.56    符合度:1.0    健全度:6.0    匹配率:0.6
        //251 [08:16:06:868 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 2.29;}     匹配条数:6/ass36    匹配度:0.56    符合度:1.0    健全度:6.0    匹配率:0.2
        //287 [08:16:06:953 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //290 [08:16:07:004 TI           TIUtils.m 535] 单特征识别结果:T282{Mnist0 = 7.23;}     匹配条数:10/ass10    匹配度:0.42    符合度:1.0    健全度:10.0    匹配率:1.0
        //292 [08:16:07:014 TI           TIUtils.m 535] 单特征识别结果:T261{Mnist0 = 2.96;}     匹配条数:10/ass36    匹配度:0.42    符合度:1.0    健全度:10.0    匹配率:0.3
        //294 [08:16:07:016 TI           TIUtils.m 535] 单特征识别结果:T357{Mnist0 = 6.19;}     匹配条数:6/ass6    匹配度:0.48    符合度:1.0    健全度:6.0    匹配率:1.0
        //324 [08:16:07:294 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //327 [08:16:07:309 TI           TIUtils.m 535] 单特征识别结果:T366{Mnist0 = 2.06;}     匹配条数:5/ass10    匹配度:0.53    符合度:1.0    健全度:5.0    匹配率:0.5
        //343 [08:16:08:030 TI           TIUtils.m1511] 单特征识别结果总结：(Mnist0=1.00 )
        //346 [08:16:08:066 TI           TIUtils.m 535] 单特征识别结果:T357{Mnist0 = 6.19;}     匹配条数:6/ass6    匹配度:0.59    符合度:1.0    健全度:6.0    匹配率:1.0
        //348 [08:16:08:068 TI           TIUtils.m 535] 单特征识别结果:T305{Mnist0 = 2.01;}     匹配条数:9/ass10    匹配度:0.42    符合度:1.0    健全度:9.0    匹配率:0.9
        //350 [08:16:08:070 TI           TIUtils.m 535] 单特征识别结果:T334{Mnist0 = 3.89;}     匹配条数:5/ass5    匹配度:0.43    符合度:1.0    健全度:5.0    匹配率:1.0
        //352 [08:16:08:072 TI           TIUtils.m 535] 单特征识别结果:T317{Mnist0 = 2.10;}     匹配条数:5/ass10    匹配度:0.43    符合度:1.0    健全度:5.0    匹配率:0.5
        //354 [08:16:08:080 TI           TIUtils.m 535] 单特征识别结果:T351{Mnist0 = 1.00;}     匹配条数:5/ass47    匹配度:0.33    符合度:1.0    健全度:5.0    匹配率:0.1
        //356 [08:16:08:086 TI           TIUtils.m 535] 单特征识别结果:T232{Mnist0 = 1.00;}     匹配条数:5/ass45    匹配度:0.30    符合度:1.0    健全度:5.0    匹配率:0.1
